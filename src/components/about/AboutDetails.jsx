      ...
      <Container>
        <div className="flex flex-col lg:flex-row justify-between items-center gap-10 lg:gap-16">
          ...
          <div className="text-center lg:text-left lg:max-w-xl w-full">
            ...
            <h2 className="text-Primary text-2xl sm:text-3xl lg:text-[45px] font-Inter font-bold leading-snug sm:leading-tight lg:leading-[55px]">
...
export default React.memo(AboutDetails);
